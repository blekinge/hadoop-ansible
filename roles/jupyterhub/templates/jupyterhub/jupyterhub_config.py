...
## Single User Server Spawner configuration
# Setup the second password prompt. This spawner sets the environment variable KERBEROS_PASSWORD before
# starting /usr/bin/sudospawner. This way, sudospawner will be able to get a kerberos ticket on behalf of the user.
...
c.JupyterHub.ssl_cert = '{{ ssl_cert_dir }}/{{ ansible_fqdn }}.crt'

## Path to SSL key file for the public facing interface of the proxy
#
#  When setting this, you should also set ssl_cert
c.JupyterHub.ssl_key = '{{ ssl_key_dir }}/{{ ansible_fqdn }}-private.pem'
...
# Here we set up the Authenticator to use PAM
...
# This is the KerberosPam Authenticator from https://github.com/jupyterhub/jupyterhub-example-kerberos
#
# I am not entirely certain that this is actually required.
...
# happening in a wholly separate pam transaction than where the env var is set.
